"""
Demonstrates a random search for finding the weights of a neural net.
...
# A tolerance of 0.5 should ensure the network works 
...
while iter < MAX_ITERS:
    ...
    guess=random_weights(scale)    #  make a random guess
