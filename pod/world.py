...
class Wall:
    ...
    def read(self,fin):
        ...
        self.rect=gui_base.Rect(self.minX,self.minY,self.maxX-self.minX,self.maxY-self.minY)
...
class World:
    ...
    def __init__(self,fileName,dt=DEFAULT_DT):
...
#         self.pods=podlist
        ...
        fin=open(fileName,"r")
        self.rect=gui_base.Rect(0,0,0,0)
...
#             self.init_pod(pod)
    ...
    # print p0_x,p0_y,p1_x,p1_y
     if  NUMPY:
        ...
        bb = (t >= -small).__iand__(t <= (1.0+small)).__iand__(s >= -small).__iand__(s <= (1.0+small))
    ...
    def step(self):
        ...
        print "Woh  I don't think I use this any more (world.step)"         
    ...
    def check_collide_with_wall(self,p0_x,p0_y,p1_x,p1_y):
        if p0_x==p1_x and p1_y==p0_y:   # No movement
            return None,None
    ...
    def draw(self,screen):
        gui_base.draw_world(self,screen)
