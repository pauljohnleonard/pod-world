...
import sys,os,imp,time,copy,pygame
...
def tester(world_name,punter_names,fout):
    ...
    for name in punter_names:
        ...
        try:
            ...
            pod.controller=punter_mod.controller
...
fout=open("results_test/results.txt","w")

punter_names=all_punters([".svn","README.txt"])
